...
Set up the PyTorch environment and built intuition for core tensor operations, masking, softmax, LayerNorm, causal attention, and manual gradients while studying the fundamentals of transformers through *Attention Is All You Need*.
